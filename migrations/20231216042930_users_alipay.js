 ...
 * @LastEditors: trexwb
 * @LastEditTime: 2024-02-21 15:02:08
 * @FilePath: /laboratory/microservice/account/migrations/20231216042930_users_alipay.js
 * @Description: 
 * @一花一世界，一叶一如来
...
exports.up = function(knex) {
    return knex.schema.createTable(`${process.env.DB_PREFIX}users_alipay`, (table) => {
        table.increments('id');
...
exports.down = function(knex) {
    return knex.schema.dropTable(`${process.env.DB_PREFIX}users_alipay`);
};
