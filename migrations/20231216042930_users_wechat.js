 ...
 * @LastEditors: trexwb
 * @LastEditTime: 2024-02-21 15:02:14
 * @FilePath: /laboratory/microservice/account/migrations/20231216042930_users_wechat.js
 * @Description: 
 * @一花一世界，一叶一如来
...
exports.up = function(knex) {
    return knex.schema.createTable(`${process.env.DB_PREFIX}users_wechat`, (table) => {
        table.increments('id');
...
exports.down = function(knex) {
    return knex.schema.dropTable(`${process.env.DB_PREFIX}users_wechat`);
};
